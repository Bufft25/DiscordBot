...
//boolean for ryan to stop spamming
var ryanStop = false;
...
BotBoy.on('message', (message) => {
    ...
    if (message.content == '!RYAN' && message.author.id != '136636689845190656') {
        ryanStop = !ryanStop;
        message.reply(ryanStop);
    }
    ...
    if (message.content == '!bruh' || message.content == '!shots' || message.content == '!triple' || message.content == '!horn2' ||
        ...
        if ((ryanStop == true && message.author.id != '136636689845190656') || ryanStop == false) { //stops ryan spam.
